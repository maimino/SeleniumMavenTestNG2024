...
public class WebUI {
    ...
    private static WebDriver driver; //khai bao
    ...
    public static void clickElement(By by, int second){
        ...
        getWebElement(by).click();
        logConsole("Click element " + by + " with timeout is " + second + " (second)");
    }
    ...
    public static void captureScreenImage(String imageName) {
        ...
        File file = new File(  "src/test/java/resource/screenshots/" + imageName + ".png");
        try {
